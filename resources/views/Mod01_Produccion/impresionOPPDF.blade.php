...
*/
        ...
        #content {
            background: url("{{ asset('images/marcaagua_'.$marcaagua.'.png') }}");
...
<body>
    <div id="content">
        ...
        <table>
            <tbody>
                <tr>
                    <th colspan="5" align="center" bgcolor="#474747" style="color:white">Ordenes que componen la Serie
                    </th>
                </tr>
                <tr>
        ...
        <table>
            <tbody>
                <tr>
                    <th colspan="2" align="center" bgcolor="#474747" style="color:white" ;scope="col">Distribución de la
                        Serie</th>
                </tr>
                <tr>
                    <td align="center" bgcolor="#ccc">Código</td>
