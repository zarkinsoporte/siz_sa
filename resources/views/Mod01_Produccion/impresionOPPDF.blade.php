        ...
        <td><table>
            ...
            <tbody>
                ...
                <tr style="background-color: white">
                    ...
                    <td  align='left' style="white-space:nowrap;"><?php echo $data[0]->ItemCode ?> - <?php echo $data[0]->ItemName ?></td>
                   
                </tr>
                <tr style="background-color: white">
                    <th align="center">Cliente:</th>
                    <td align="left"  style="white-space:nowrap;"><?php echo $data[0]->CardCode ?> - <?php echo $data[0]->CardName ?></td>
