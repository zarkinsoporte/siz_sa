...
<div class="container" >
     ...
     <h4>Confidencialidad/Responsabilidades</h4>
        ...
        <h6>3. QUEDA ESTRICTAMENTE PROHIBIDO LA DESCARGA, INSTALACION O DISTRIBUCION DE SOFTWARE QUE NO SEA PROPORCIONADO POR EL AREA DE SISTEMAS</h6>
        ...
        <h6>5. LA CONSERVACION Y USO OPTIMO DEL BIEN INFORMÁTICO, ES RESPONSABILIDAD DIRECTA DEL ENCARGADO, EL CUAL DEBERÁ DAR AVISO A SISTEMAS EN CASO DE EXTRAVIO O DE DAÑO AL EQUIPO</h6>
        <h6>6. AL TERMINO DE LAS LABORES EL RESPONSABLE VERIFICARÁ QUE EL EQUIPO SE ENCUENTREN DEBIDAMENTE APAGADO</h6>
        <h6>7. LOS USUARIOS DE LAS COMPUTADORAS NO PODRAN CAMBIAR LA CONFIGURACION DE LOS EQUIPOS</h6>
        ...
        <h6>9. TODOS LOS USUARIOS QUE REQUIERAN DE UN ADITAMENTO PARA SU EQUIPO, DEBERÁN SOLICITARLO A EL DEPARTAMENTO DE SISTEMAS A TRAVÉS DE UN CORREO ELECTRÓNICO</h6>
