    ...
    <div class="col-md-12" style="margin-bottom: 5px">
        ...
        <div class="form-group">
            <div class="col-md-3 col-md-offset-1">
                ...
                <input type="number" id="tc_usd">
            </div>
            <div class="col-md-3">
                <label><strong>
                        <font size="2">CAN</font>
                    </strong></label>
                <input type="number" id="tc_can">
            </div>
            <div class="col-md-3">
                <label><strong>
                        <font size="2">EUR</font>
                    </strong></label>
                <input type="number" id="tc_eur">
            </div>
            <div class="col-md-2">
                <p style="margin-bottom: 23px"></p>
                <button type="button" class="form-control btn btn-primary m-r-5 m-b-5" id="boton-mostrar"><i class="fa fa-cogs"></i> Filtrar</button>
            </div>
        ...
        $(window).on('load', function() {
            ...
            var data,
                ...
                jqxhr = $.ajax({
                    ...
                    url: '{!! route('
                    datatables_simulador_detalle_modelos ') !!}',
                    beforeSend: function() {
                        $.blockUI({
