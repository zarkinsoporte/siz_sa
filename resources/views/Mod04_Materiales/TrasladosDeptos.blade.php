      ...
      <tbody>
        ...
        <tr <?php ?>>
          ...
          <a id="btneditar" ng-click="editar($event)" role="button" data-toggle="modal" 
                data-target="#edit" 
                data-id="{{$art->Id}}" 
                data-itemcode="{{$art->ItemCode}}"  
                data-cantp="{{$art->Cant_PendienteA}}" 
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content" >
        ...
        <div class="row">
         <div class="col-md-12">
          ...
          <div class="form-group col-md-12">
            ...
            <input ng-model="canta" id="cantp" name="cantp" type="number" class="form-control" min="0" step="any" max="@{{cantp}}" required>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-default" data-dismiss="modal">Cerrar</button>
          <button data-ng-disabled="pendiente < (canta) || (canta) == 0" type="submit" class="btn btn-primary">Guardar</button>
      </div>
      {!! Form::close() !!}
