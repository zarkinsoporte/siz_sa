  ...
  <div class="row">
    <div class="col-md-12">
      <span class="pull-right">
        ...
        <a class="btn btn-primary btn-sm" href="{{url('/home/entregas_lotes')}}"><i class="fa fa-angle-left"></i> Otras
          Entregas Pendientes</a>

        @if ($itemsConLotes > 0 && count($articulos_validos) > 0)
        <a class="btn btn-success btn-sm" disabled><i class="fa fa-send"></i> Enviar Entrega</a>
        @elseif(count($articulos_validos) > 0)
        <a class="btn btn-success btn-sm" href="{{url('/home/TRASLADO ENTREGA/update/'.$almacen_origen.'/'.$id)}}"><i
            class="fa fa-send"></i> Enviar Entrega</a>
        @endif
