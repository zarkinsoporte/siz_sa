...
Route::post('guardar_acabado', 'Mod08_DisenioController@guardar_acabado')->name('guardar_acabado');
...
Route::any('get-rates', 'Mod03_ComprasController@get_rates')->name('get-rates');
...
Route::get('/incoming/imagen/{id}', 'Mod_IncomingController@verImagen');

//CALIDAD RECHAZOS
Route::get('home/RECHAZOS', 'Mod_RechazosController@index_rechazos')->middleware('routelog');
Route::get('home/RECHAZOS/buscar', 'Mod_RechazosController@buscarRechazos');
Route::post('home/RECHAZOS/generar', 'Mod_RechazosController@generarRechazo');
Route::get('home/RECHAZOS/ver-inspeccion', 'Mod_RechazosController@verInspeccion');
...
Route::get('home/REP-04-CONFIABILIDAD-PROV', 'Reportes_IncomingController@index_rep04')->middleware('routelog');
